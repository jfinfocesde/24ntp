...
* Accede a la consola de Google Cloud Platform: [https://console.cloud.google.com/](https://console.cloud.google.com/)
...
[https://toml-to-json.matiaskorhonen.fi/](https://toml-to-json.matiaskorhonen.fi/)
...
- **Descripción:** Se muestra un mensaje introductorio.
- **Pestañas internas:** Se crean dos pestañas ("Usuarios" y "Productos") usando `st.tabs()`.
- **Usuarios:**
...
* **`st.subheader("Análisis y Filtrado de Datos")`**: Define un subtítulo para la página, indicando el tema principal de la aplicación.
...
|  Nomenclatura (snake_case) | 2 |
|  Imágenes Optimizadas | 2 |
|  Diseño y presentación | 4 |
| **2. Aplicación 1 (Proyecto Integrador) (15 puntos)** |  |
|  Conexión Firebase - Firestore | 3 |
|  Análisis exploratorio | 3 |
|  Filtros dinámicos con gráficos | 3 |
|  Gráficos | 3 |
|  Coherencia con el proyecto integrador | 3 |
| **3. Aplicación 2 (Análisis dataset) (15 puntos)** |  |
|  Carga del Dataset | 3 |
|  Análisis exploratorio | 3 |
|  Filtros dinámicos | 3 |
|  Gráficos | 3 |
|  Reportes con información significativa | 3 |
| **4. Aplicación 3 (Google Sheet) (15 puntos)** |  |
|  Conexión con la API Google Sheet | 5 |
|  Analítica del documento de Google Sheet | 5 |
|  Reportes con información significativa | 5 |
| **5. Aplicación 4 (AI - Gemini) (15 puntos)** |  |
|  Conexión con la API Gemini | 5 |
|  Creatividad en la aplicación | 10 |
| **6. GitHub (10 puntos)** |  |
|  Repositorio organizado | 4 |
|  Manejo de ramificaciones | 3 |
|  Commits con mensajes descriptivos | 3 |
| **7. Streamlit cloud (10 puntos)** |  |
|  Despliegue de la aplicación | 10 |
| **8. Funcionalidad/Objetivo (10 puntos)** |  |
|  Cumple con los requisitos funcionales | 10 |
