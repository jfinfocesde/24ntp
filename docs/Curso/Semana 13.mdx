...
Seaborn ofrece un conjunto de conjuntos de datos de muestra integrados que puedes usar para practicar y explorar diferentes técnicas de visualización de datos. Estos datasets predefinidos  facilitan el aprendizaje y la experimentación sin necesidad de recopilar o preparar datos adicionales. 
...
## Lista Completa y Descripción

### Datos Socioeconómicos y Demográficos
1. **tips**
   - Datos de propinas de un restaurante
   - Variables: total_bill, tip, sex, smoker, day, time, size
   - Útil para: regresión, visualización categórica

2. **titanic**
   - Datos de pasajeros del Titanic
   - Variables: survived, pclass, sex, age, sibsp, parch, fare, embarked
   - Útil para: clasificación binaria, análisis de supervivencia

3. **exercise**
   - Datos de ejercicio y tiempo de reacción
   - Variables: id, kind, time, pulse
   - Útil para: análisis de medidas repetidas

4. **taxis**
   - Datos de viajes en taxi
   - Variables: pickup, dropoff, passengers, distance, fare, tip, tolls
   - Útil para: análisis de series temporales, regresión

### Datos Científicos y Biológicos
5. **iris**
   - Mediciones de flores iris
   - Variables: sepal_length, sepal_width, petal_length, petal_width, species
   - Útil para: clasificación multiclase

6. **penguins**
   - Mediciones de pingüinos de Palmer
   - Variables: species, island, bill_length_mm, bill_depth_mm, flipper_length_mm, body_mass_g, sex
   - Útil para: clasificación multiclase, análisis multivariado

7. **planets**
   - Datos de planetas extrasolares
   - Variables: method, number, orbital_period, mass, distance, year
   - Útil para: análisis astronómico

8. **brain_networks**
   - Datos de redes cerebrales
   - Útil para: análisis de redes, neurociencia

### Datos de Productos y Mercado
9. **diamonds**
   - Precios y características de diamantes
   - Variables: carat, cut, color, clarity, depth, table, price
   - Útil para: regresión, análisis de precios

10. **car_crashes**
    - Estadísticas de accidentes de tráfico
    - Variables: total, speeding, alcohol, not_distracted, no_previous
    - Útil para: análisis de seguridad vial
...
### Datos de Comportamiento y Psicología
12. **attention**
    - Datos de experimentos de atención
    - Útil para: análisis de comportamiento

13. **dots**
    - Experimento de percepción visual
    - Útil para: análisis de percepción

14. **gammas**
    - Datos de percepción gamma
    - Útil para: psicofísica

### Datos Climáticos y Ambientales
15. **geyser**
    - Datos de erupciones del Old Faithful
    - Variables: waiting, duration
    - Útil para: análisis de clustering

16. **anscombe**
    - Cuarteto de Anscombe
    - Útil para: demostrar importancia de visualización

### Otros Datasets
17. **mpg**
    - Datos de consumo de combustible
    - Variables: mpg, cylinders, displacement, horsepower, weight, acceleration, year, origin, name
    - Útil para: regresión, análisis de eficiencia

18. **healthexp**
    - Gastos en salud por país
    - Útil para: análisis económico de salud

19. **fmri**
    - Datos de resonancia magnética funcional
    - Útil para: análisis de series temporales en neurociencia

20. **dowjones**
    - Índice Dow Jones
    - Útil para: análisis financiero

## Características por Dataset

### Tamaño de los Datasets
- **Pequeños** (`<`1000 filas):
  - iris (150 filas)
  - tips (~240 filas)
  - anscombe (11 filas por grupo)

- **Medianos** (1000-10000 filas):
  - diamonds (~54000 filas)
  - flights (~144 filas)
  - titanic (~890 filas)

- **Grandes** (>10000 filas):
  - planets (~100000 filas)

### Tipos de Variables
1. **Numéricas Continuas**
   - tips: total_bill, tip
   - iris: medidas de pétalos y sépalos
   - diamonds: carat, price

2. **Categóricas**
   - tips: day, time, sex, smoker
   - titanic: survived, class, sex
...
### Para Aprendizaje de Visualización
1. **Gráficos Básicos**
   - tips
   - iris
   - penguins
...
## Guía de Visualizaciones con Seaborn en Streamlit

Esta guía muestra cómo crear diferentes tipos de visualizaciones usando Seaborn en Streamlit, con ejemplos prácticos y código documentado.
...
1. **Memoria y Rendimiento:**
   ...
   - Limpiar figuras después de mostrarlas: `plt.close(fig)`

2. **Diseño:**
   - Usar títulos descriptivos
   - Incluir explicaciones con `st.write()`
   - Organizar controles en el sidebar

3. **Interactividad:**
   - Permitir personalización de parámetros
   - Incluir opciones para mostrar/ocultar elementos
   - Añadir filtros relevantes

4. **Documentación:**
   - Incluir descripción de los datos
   - Explicar las visualizaciones
