...
- Portal oficial de datos abiertos de Colombia
- Contiene datasets de todas las entidades gubernamentales
- Incluye información sobre salud, educación, economía, etc.
- Permite la descarga de datos en múltiples formatos
- Ofrece visualizaciones y APIs para acceso a datos

### Ministerio de Educación - Datos Abiertos
**URL**: https://www.mineducacion.gov.co/portal/estadisticas/Datos-Abiertos-MEN/
- Portal específico para datos educativos
...
- Portal específico para la capital colombiana
...
### Datos Abiertos Área Metropolitana
**URL**: https://datosabiertos.metropol.gov.co/
- Enfocado en el área metropolitana específica
- Información sobre:
...
- Buscador especializado en datasets
- Indexa múltiples fuentes de datos
- Permite búsqueda avanzada de conjuntos de datos
- Incluye datasets de todo el mundo
- Ofrece metadatos detallados

### Kaggle Datasets
**URL**: https://www.kaggle.com/datasets
- Plataforma de ciencia de datos y machine learning
- Contiene datasets para:
  * Competencias de análisis de datos
  * Proyectos de aprendizaje automático
  * Investigación
  * Práctica y educación
- Incluye notebooks y códigos de ejemplo
- Comunidad activa de científicos de datos

## Características Comunes
- Datos en formatos abiertos (CSV, JSON, XML)
- Licencias de uso público
