  ...
  <table class="border-collapse border border-gray-300">
    <thead>
      <tr>
        ...
        <th class="border border-gray-300 px-4 py-2">Lenguajes compilados</th>
        <th class="border border-gray-300 px-4 py-2">Lenguajes interpretados</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td class="border border-gray-300 px-4 py-2 font-bold">Ejemplos</td>
        <td class="border border-gray-300 px-4 py-2">C, C++, Rust, Go, Haskell</td>
        <td class="border border-gray-300 px-4 py-2">Python, Ruby, JavaScript, PHP</td>
      </tr>
      <tr>
        <td class="border border-gray-300 px-4 py-2 font-bold">Traducción</td>
        <td class="border border-gray-300 px-4 py-2">Se realiza una vez, antes de la ejecución</td>
        <td class="border border-gray-300 px-4 py-2">Se realiza cada vez que se ejecuta el programa</td>
      </tr>
      <tr>
        <td class="border border-gray-300 px-4 py-2 font-bold">Velocidad</td>
        <td class="border border-gray-300 px-4 py-2">Suelen ser más rápidos y eficientes</td>
        <td class="border border-gray-300 px-4 py-2">Suelen ser más lentos y consumir más recursos</td>
      </tr>
      <tr>
        <td class="border border-gray-300 px-4 py-2 font-bold">Portabilidad</td>
        <td class="border border-gray-300 px-4 py-2">Dependen de la plataforma y el compilador</td>
        <td class="border border-gray-300 px-4 py-2">Son independientes de la plataforma y el intérprete</td>
      </tr>
      <tr>
        <td class="border border-gray-300 px-4 py-2 font-bold">Depuración</td>
        <td class="border border-gray-300 px-4 py-2">Es más difícil encontrar y corregir errores</td>
        <td class="border border-gray-300 px-4 py-2">Es más fácil encontrar y corregir errores</td>
      </tr>
      <tr>
        <td class="border border-gray-300 px-4 py-2 font-bold">Flexibilidad</td>
        <td class="border border-gray-300 px-4 py-2">Suelen ser más rígidos y estrictos</td>
        <td class="border border-gray-300 px-4 py-2">Suelen ser más dinámicos y flexibles</td>
      </tr>
      <tr>
        <td class="border border-gray-300 px-4 py-2 font-bold">Control</td>
        <td class="border border-gray-300 px-4 py-2">Permiten un mayor control sobre el hardware</td>
        <td class="border border-gray-300 px-4 py-2">Abstraen el hardware y lo gestionan automáticamente</td>
      </tr>
      <tr>
        <td class="border border-gray-300 px-4 py-2 font-bold">Tamaño</td>
        <td class="border border-gray-300 px-4 py-2">Suelen generar archivos ejecutables más grandes</td>
        <td class="border border-gray-300 px-4 py-2">Suelen generar archivos de código fuente más pequeños</td>
      </tr>
    </tbody>
  </table>
</div>
...
<div class="max-w-3xl mx-auto m-8">
...
[Bienvenid@ a El Libro De Python](https://ellibrodepython.com/)
